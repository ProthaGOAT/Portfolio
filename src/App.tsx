...
export default function PortfolioLandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-gradient-to-br from-[#ffffff] via-[#edf4fb] to-[#d6f0ff] dark:from-[#0d1a2a] dark:via-[#101e2e] dark:to-[#152c47] text-gray-800 dark:text-white">
      ...
      {!showIntro && (
        <main className="flex-grow pb-28 md:pb-16 relative">
          {/* Sections */}
          {activeTab === 'home' && (
          ...
          {/* Floating Nav */}
          <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 md:top-1/2 md:bottom-auto md:left-4 md:translate-x-0 md:-translate-y-1/2 z-50">
            <div className="bg-white dark:bg-[#101826] rounded-full shadow-lg flex md:flex-col items-center gap-4 p-4 border border-gray-300 dark:border-gray-700">
      ...
      {/* Footer */}
      <footer className="py-3 text-center text-sm bg-white dark:bg-gray-800 border-t border-gray-300 dark:border-gray-700">
